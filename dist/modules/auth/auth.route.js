...
router.patch("/updateProfile/:authId", auth_middleware_1.authenticate, auth_controller_1.updateProfile);
// ================= Admin routes =================
// Block / Unblock user
...
router.get("/auth-ids", auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)(["admin"]), auth_controller_1.getAllAuthIds);
